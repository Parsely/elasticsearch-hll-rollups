...
public final class CardinalityAggregationBuilder
    ...
    public static final String NAME = "hll-cardinality";

    // FIXME: Delete `precision_threshold`
    public static final ParseField PRECISION_THRESHOLD_FIELD = new ParseField("precision_threshold");

    public static final ObjectParser<CardinalityAggregationBuilder, Void> PARSER;
    static {
